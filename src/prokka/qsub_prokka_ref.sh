...
#PBS -e /home/projects/cge/people/cathom/ref/prokka/prokka.err
#PBS -o /home/projects/cge/people/cathom/ref/prokka/prokka.log
...
${path}/src/prokka/run_prokka_ref.sh -p ${path} -n ${n}
